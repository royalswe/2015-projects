...
namespace AdventurousContact.Models.DataModels
{
    using System;
    ...
    public partial class AdventureWorksAssignmentEntities : DbContext
    {
        public AdventureWorksAssignmentEntities()
            : base("name=AdventureWorksAssignmentEntities")
        {
        }
